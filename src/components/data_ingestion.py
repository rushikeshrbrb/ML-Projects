...
class DataIngestionCongig:
    train_data_path:str=os.path.join('artifacts','tarin_csv')
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        logging.info("Enter the methode or component")
